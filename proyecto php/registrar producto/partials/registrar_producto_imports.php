...
<div class="cproducto" id="clasificacion">
    <div class="ventan1">
        ...
        <div class="texto1">
            ...
            <h1>Nombre </h1>
            <a href="#" id="agregar_producto_clasificacion" class="link_Agregar_producto_clasificacion"><i
                ...
                <form name="form_nuevo_proveedor_venta" id="form_nuevo_proveedor_venta"
                    ...
                    <div class="registro_documento_proveedor">
                        <label>Documento :<label>
                                ...
                                <a href="" id="buscar_proveedor_registro" class="link_buscar_proveedor_registro"><i
                                        class="fas fa-search"></i></a>

                                <a href="#gestionar_proveedor" class="tbn_nuevo_proveedor"><i
            ...
            <table class="tbl_venta">
                <thead>
                    ...
                    <tr>
                        ...
                        <td><input type="number" name="txt_disponibilidad_factura_registro"
                                id="txt_disponibilidad_factura_registro" value="0" min="0" disabled> </td>
                        <td id="txt_precio_unidad_registro" class="textright">0.00</td>
                        <td><input type="number" name="txt_cant_producto_registro" id="txt_cant_producto_registro"
                                value="0" min="0"></td>
                ...
                <tbody id="detalle_venta">
                    ...
                    <tr>
                        ...
                        <td>360000</td>
                        <td>
                            <a class="link_eliminar" href="" onclick="event.preventDefault()(7707294382076);"><i
